    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>349/356</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">86.19% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>231/268</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>339/345</span>
            </div>
...
<a name='L1002'></a><a href='#L1002'>1002</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
OAuthClient.prototype.createToken = function createToken(uri) {
  return new Promise((resolve) =&gt; {
    ...
    const queryPart = queryIndex !== -1 ? uri.substring(queryIndex + 1) : <span class="branch-1 cbranch-no" title="branch not covered" >uri;</span>
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('state' in params) this.token.state = params.state;
&nbsp;
    const body = {};
    if (params.code) {
...
&nbsp;
      if (status === 400 &amp;&amp; data &amp;&amp; data.Fault) {
        ...
        const faultType = (fault &amp;&amp; fault.type) || <span class="branch-2 cbranch-no" title="branch not covered" >'ValidationFault';</span>
      ...
      if (status === 400) {
        throw new OAuthError(
          (data &amp;&amp; data.error) || <span class="branch-2 cbranch-no" title="branch not covered" >'Bad Request',</span>
          '400',
          (data &amp;&amp; data.error_description) || <span class="branch-2 cbranch-no" title="branch not covered" >'Request validation failed',</span>
          intuitTid,
        );
      }
&nbsp;
...
&nbsp;
      throw new OAuthError(
        (data &amp;&amp; data.error) || <span class="branch-2 cbranch-no" title="branch not covered" >'HTTP Error',</span>
        status.toString(),
        (data &amp;&amp; data.error_description) || <span class="branch-2 cbranch-no" title="branch not covered" >`HTTP ${status} error`,</span>
        intuitTid,
      );
    }
...
&nbsp;
    ...
    .catch((e) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!e.authResponse) {
