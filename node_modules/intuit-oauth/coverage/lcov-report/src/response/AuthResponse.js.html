      ...
      try {
        ...
        if (parsedBody.Fault) {
          this.json = {
            ...
            time: parsedBody.time || <span class="branch-1 cbranch-no" title="branch not covered" >new Date().toISOString(),</span>
            intuit_tid: this.intuit_tid,
          };
        } else {
          // Store the raw response data
    ...
    try {
      ...
      if (this.json.Fault) {
        this.json = {
          ...
          time: this.json.time || <span class="branch-1 cbranch-no" title="branch not covered" >new Date().toISOString(),</span>
          intuit_tid: this.intuit_tid,
        };
      }
